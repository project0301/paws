...
function AddProduct(props) {
 const [formState, setFormState] = useState({ title: "", description: "", image: "", quantity: "", price: "", category: ""});
 ...
 const handleFormSubmit = async (event) => {
  ...
  <div class="my-3 grid grid-cols-1 sm:grid-cols-5">
      <form action="/action_page.php" method="get" target="_blank">
        <label for="quantity">Price: *required</label>
            <input type="number" step="0.01" id="product-price" placeholder="PRICE" class="col-span-3 lg-col-span-2" />
            </form>
  </div>
  ...
  <div class="my-3 grid grid-cols-1 sm:grid-cols-5">
                <label for="category" class="col-span-2">Category: *required</label>
